...
private int searchDepth;
  ...
  public Move chooseMove() {
    //Move my_move = abPruner(true, searchDepth, this.color, 1 - this.color, board.MINBOARDSCORE, board.MAXBOARDSCORE);
    Move my_move = bestMove(true, searchDepth, this.color, 1-this.color);
